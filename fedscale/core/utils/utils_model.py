...
def test_model(rank, model, test_data, device='cpu', criterion=nn.NLLLoss(), partitions=None, tokenizer=None):
    ...
    logging.info('Rank {}: Test set: Average loss: {}, Top-1 Accuracy: {}/{} ({}), Top-5 Accuracy: {}, Per-Client Top-1 Accuracy: {}'
          .format(rank, test_loss, correct, len(test_data.dataset), acc, acc_5, acc_clients))
